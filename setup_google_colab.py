...
def download_github_code(path):
    ...
    os.system("wget https://raw.githubusercontent.com/sebglon/natural-language-processing/master/{} -O {}".format(path, filename))
...
def setup_project():
    ...
    download_github_code("project/data/word_embeddings.tsv")
    setup_starspace()
